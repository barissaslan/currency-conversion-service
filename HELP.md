...
* The original package name 'com.aslanbaris.currency-conversion-service' is invalid and this project uses 'com.aslanbaris.currencyconversionservice' instead.
